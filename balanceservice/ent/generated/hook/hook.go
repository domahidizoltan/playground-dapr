...
import (
	...
	"github.com/domahidizoltan/playground-dapr/balanceservice/ent/generated"
)

// The BalanceFunc type is an adapter to allow the use of ordinary
// function as Balance mutator.
type BalanceFunc func(context.Context, *generated.BalanceMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f BalanceFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.BalanceMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generated.BalanceMutation", m)
}
