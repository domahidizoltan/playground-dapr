...
func (bq *BalanceQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (bq *BalanceQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(balance.Table, balance.Columns, sqlgraph.NewFieldSpec(balance.FieldID, field.TypeString))
	_spec.From = bq.sql
